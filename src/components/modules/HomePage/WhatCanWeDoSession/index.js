...
function WhatCanWeDo() {
    return (
        <div style={parentContainer}>
            <div style={container}>
                <h2 className="contrastText">What <span className="contrastBold">can we do</span> for you?</h2>

                <ul style={listContainer}>

                    <li style={list}>
                        <CheckCircleOutlineIcon style={checkedIcon}/>
                        <p className='contrastText'>enstant.com provides you with a
                            <span className='contrastBold'> quicker, easier and smarter solution </span>
                    ...
                    <li style={list}>
                        <CheckCircleOutlineIcon style={checkedIcon}/>
                        <p className='contrastText'>enstant.com allows you to
                    ...
                    <li style={list}>
                        <CheckCircleOutlineIcon style={checkedIcon}/>
                        <p className='contrastText'>enstant.com sets up a
                            <span className='contrastBold'> password protected private website </span>
                    ...
                    <li style={list}>
                        <CheckCircleOutlineIcon style={checkedIcon}/>
                        <p className='contrastText'>Users can
                            <span className='contrastBold'> instantly preview </span>
                            an online proof, speeding up the proofing cycle and preventing errors.
                        </p>
                    </li>
