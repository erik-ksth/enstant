...
function WhatDoYouWant() {
     return (
          <Container>
               <h2>What Do You <span style={{color: 'var(--primary-blue)'}}>Want?</span></h2>
               <p className="description">If you are looking for the following requirements, you've just found the right vendor, <span>enstant.com</span>!</p>
